...
public class WrapDataInputStream extends InputStream implements DataInput {

    /**
     * The input stream.
     */
    protected WrapByteArrayInputStream in;
     ...
     */
    public WrapDataInputStream(WrapByteArrayInputStream in) {
        this.in = in;
    }
	...
	public WrapDataInputStream duplicate() {
		return new WrapDataInputStream(in.duplicate());
	}
}
